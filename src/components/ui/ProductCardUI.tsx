...
export const ProductCardUI = ({ product }: ProductCardUIProps) => {
  return (
    <HeadlessProductCard product={product}>
      {(logic) => (
        <Card className="group border-2 hover:border-primary transition-all duration-300 hover:shadow-lg">
              ...
              <div className="aspect-square bg-muted rounded-lg mb-3 overflow-hidden relative">
                ...
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  ...
                  {logic.product.featured && (
                    <span className="bg-secondary text-secondary-foreground text-xs px-3 py-1 rounded-full font-semibold shadow-md">
                      Featured
                    </span>
                  )}
                  {!logic.inStock && (
                    <span className="bg-muted text-muted-foreground text-xs px-3 py-1 rounded-full font-semibold shadow-md">
                      Sold Out
                    </span>
                  )}
                </div>
